...
def main():
    ...
    parser.add_argument("--client_ip", required=False, default=BBConfig.get('brainboost_server_vm_redis_private_ip_0'))
    parser.add_argument("--client_port", required=False, default=BBConfig.get('brainboost_server_vm_redis_private_port_0'), type=int)
    ...
    BBLogger.log("datasource_launcher.py: Using client Redis at {}:{}".format(args.client_ip, args.client_port))
